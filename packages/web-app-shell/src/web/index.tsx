      ...
      >
        <div className="absolute inset-0 z-1 flex min-h-0 overflow-hidden">
          <div className="relative flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
            {centerStage}
            <div className="composer-dock-zone pointer-events-auto absolute inset-x-0 bottom-0 px-[60px] pb-[calc(1rem+25px)]">
              <div className="chat-composer-dock pointer-events-none bg-transparent">
                {centerDock}
              </div>
            </div>
