...
.fsdb-right-body:has(.fsdb-detail-stage) .fsdb-detail-stage,.fsdb-right-body:has(.fsdb-detail-stage) .fsdb-detail-screen,.fsdb-right-body:has(.fsdb-detail-stage) .fsdb-detail-split{width:100%;align-self:stretch;box-sizing:border-box}
