...
.fsdb-right-body:has(.chat-pane-embed)>*{display:flex;flex-direction:column;min-height:0;flex:1 1 0;height:100%;overflow:hidden}
.fsdb-right-body:has(.chat-pane-embed) .fsdb-detail-stage{display:flex;min-height:0;flex:1 1 0;height:100%;overflow:hidden}
.fsdb-detail-stage:has(.chat-pane-embed),
.fsdb-detail-screen:has(.chat-pane-embed){min-height:0;flex:1 1 0;height:100%;overflow:hidden}
.fsdb-detail-screen:has(.chat-pane-embed) .fsdb-detail-split,
.fsdb-detail-main:has(.chat-pane-embed){min-height:0;flex:1 1 0;height:100%;overflow:hidden;display:flex;flex-direction:column}
.fsdb-fileview:has(.chat-pane-embed){display:flex;flex-direction:column;flex:1 1 0;min-height:0;height:0;overflow:hidden}
.fsdb-detail-main:has(.chat-pane-embed){padding:8px 12px 0;gap:4px;background:#191919}
.fsdb-detail-main:has(.chat-pane-embed) .fsdb-detail-title-row{flex:none;margin:0;padding:0}
.fsdb-detail-main:has(.chat-pane-embed) .fsdb-detail-aside{display:none}
