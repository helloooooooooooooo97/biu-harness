...
.fsdb-detail-float-nav{position:sticky;top:50%;align-self:flex-start;flex:none;z-index:24;display:flex;flex-direction:column;gap:2px;margin:0 10px 0 4px;padding:3px;border:0;border-radius:6px;background:rgba(255,255,255,.10);box-shadow:0 1px 2px rgba(15,15,15,.04);backdrop-filter:blur(4px);-webkit-backdrop-filter:blur(4px);transform:translateY(-50%)}
.fsdb-detail-float-btn{display:flex;width:24px;height:24px;align-items:center;justify-content:center;margin:0;border:0;border-radius:5px;padding:0;background:transparent;color:#a3a3a3;cursor:pointer}
.fsdb-detail-float-btn svg{width:14px;height:14px}
