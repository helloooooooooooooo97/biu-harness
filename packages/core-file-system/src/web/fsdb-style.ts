...
.fsdb-page .tasks-title-aside{position:absolute;right:var(--fsdb-row-tools-w);top:50%;z-index:2;display:inline-flex;align-items:center;gap:0;transform:translateY(-50%);pointer-events:none}
