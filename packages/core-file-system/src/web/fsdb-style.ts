...
.fsdb-page .tasks-minicard-title{display:flex;align-items:flex-start;gap:6px;padding-right:var(--fsdb-row-tools-w);font-size:14px;font-weight:600;line-height:1.25}
