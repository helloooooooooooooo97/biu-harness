...
test('list and detail share the chat column max width with side padding', () => {
  ...
  assert.match(css, /\.fsdb-page \.tasks-minicard-title\{[^}]*padding-right:0/)
  assert.match(css, /\.fsdb-page \.tasks-queue-item-body\{[^}]*padding:6px var\(--fsdb-row-tools-w\) 6px 0/)
  assert.match(css, /\.fsdb-page \.tasks-queue-item-lead\{[^}]*position:static/)
  ...
  assert.match(css, /\.fsdb-page \.tasks-minicard-titletext \.fsdb-title-text,[\s\S]*text-overflow:ellipsis/)
