...
test('title cell row tools skip the overflow action menu', () => {
  ...
  assert.match(css, /\.fsdb-detail-actions \.dock-icon-btn\{[^}]*width:32px/)
  assert.match(css, /\.fsdb-detail-actions \.dock-icon-btn\{[^}]*height:32px/)
  assert.match(css, /\.fsdb-detail-actions \.dock-icon-btn\{[^}]*color:#F0EFED/)
  assert.match(css, /\.fsdb-detail-actions \.dock-icon-btn\{[^}]*border-radius:50%/)
