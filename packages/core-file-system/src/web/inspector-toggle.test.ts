...
test('deletable tables can pick rows and bulk-delete next to refresh', () => {
  ...
  assert.match(cells, /<RefFieldPop/)
  ...
  assert.match(people, /\/api\/sessions/)
  ...
  assert.match(media, /kind === 'image' \? <ArrowUpTrayIcon/)
  assert.match(media, /kind === 'image' \? null : <span className="fsdb-media-pick-label"/)
  ...
  assert.match(refs, /function RefFieldPop/)
  assert.match(refs, /<CellPop/)
  assert.match(refs, /fsdb-ref-host/)
