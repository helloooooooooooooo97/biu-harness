...
test('database extras sit after the record detail, not in the inspector', () => {
  ...
  assert.match(detail, /bg-white\/10/)
  assert.match(detail, /backdrop-blur-sm/)
  assert.match(detail, /size-8/)
  assert.match(detail, /rounded-lg/)
  assert.doesNotMatch(detail, /fsdb-detail-float-btn/)
