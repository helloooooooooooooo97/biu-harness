...
.tasks-minicard { display:flex; flex-direction:column; gap:8px; width:100%; min-width:0; min-height:92px; overflow:hidden; text-align:left; border:0; border-radius:8px; padding:10px 11px; background:var(--dsw-sidebar); color:var(--dsw-label); font:inherit; cursor:pointer; box-shadow:none; transition:background .12s ease; }
.tasks-minicard:hover { background:var(--dsw-hover); }
.tasks-minicard.is-active { background:var(--dsw-hover); }
